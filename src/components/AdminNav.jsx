...
export function AdminNav() {
  ...
  const showDashboard = isSuperAdmin(user) || isOrderManager(user) || isDeliveryManager(user)
  const showOrders    = isSuperAdmin(user) || isOrderManager(user) || isDeliveryManager(user)
  const showProducts  = isSuperAdmin(user) || isOrderManager(user) || isProductOperator(user)
